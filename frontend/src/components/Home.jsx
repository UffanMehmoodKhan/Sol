  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col items-center justify-center text-center px-4 min-h-[60vh]">
        ...
        <p className="relative text-lg md:text-xl text-gray-300 max-w-xl z-10">
          Your one-stop solution for all weather data. Accurate, real-time updates, wherever you are.
        </p>
      </div>

      <section className="mt-20 px-6 py-16 bg-black text-green-300">
        <motion.h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-900 border border-green-600 rounded-xl p-6 shadow-lg hover:shadow-green-500/40 transition duration-300"
            >
      ...
      <section className="flex flex-col md:flex-row items-center justify-between gap-10 px-6 py-20 bg-[#0a0a0a]">
